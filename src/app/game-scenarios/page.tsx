...
export default function GameScenariosPage() {
  ...
  const scenarios: Scenario[] = [
    ...
    },
    {
      ...
      titleTa: 'வீட்டுக் கடன் திட்டமிடல்',
      description: 'Make smart decisions about buying your first home and managing mortgage',
      descriptionTa: 'உங்கள் முதல் வீட்டை வாங்குவது மற்றும் அடமானத்தை நிர்வகிப்பது பற்றிய புத்திசாலித்தனமான முடிவுகள்',
      icon: Home,
    ...
    },
    {
      ...
      titleTa: 'வாகன நிதியளிப்பு',
      description: 'Learn to balance vehicle purchase with other financial goals',
      descriptionTa: 'வாகன வாங்குதலை மற்ற நிதி இலக்குகளுடன் சமநிலைப்படுத்த கற்றுக் கொள்ளுங்கள்',
      icon: Car,
      difficulty: 'intermediate',
      isAvailable: false,
