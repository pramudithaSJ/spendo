...
export default function ProfilePage() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      href: '/reports',
      color: 'text-bee-secondary bg-blue-50 dark:bg-blue-950/40 dark:text-bee-secondary'
    },
    {
      icon: Calculator,
      ...
      <div className="p-4 space-y-6">
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="p-4">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center text-indigo-600 bg-indigo-50 dark:bg-indigo-950/40 dark:text-indigo-400">
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="p-4">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center text-bee-primary bg-yellow-50 dark:bg-yellow-950/40">
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="p-4">
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center text-yellow-600 bg-yellow-50 dark:bg-yellow-950/40">
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="p-4">
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full flex items-center justify-center space-x-2 text-red-600 border-red-200 hover:bg-red-50 dark:hover:bg-red-950/30"
            >
